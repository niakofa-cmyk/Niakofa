/**
 * Niakofa Seed — Regional Crisis Resources (13 major US cities + 4 Brazilian hubs)
 *
...
const REGIONS: RegionEntry[] = [
  ...
  // ─── Brazilian Diaspora Hubs ─────────────────────────────────────────────
  // Priority cities matching the Griot Globe diaspora_hubs seeds.
  // SAMU (192) = national emergency medical (equiv. to 911 EMS).
  // CVV (188)  = national suicide/crisis line (24/7 free, equiv. to 988).
  // Resources verified against official municipal/state websites (2026-07).
  {
    region_key: "salvador_bahia_br",
    region_display: "Salvador, Bahia, Brasil",
    state_code: "BA",
    country_code: "BR",
    notes: "Verified: SAMU 192, CVV 188, Defesa Civil 199. Salvador / Bahia official municipal sources (2026-07).",
    resources: [
      { label: "SAMU — Emergência Médica", phone: "192" },
      { label: "Bombeiros (Incêndio/Resgate)", phone: "193" },
      { label: "Polícia Militar", phone: "190" },
      { label: "CVV — Centro de Valorização da Vida (crise/suicídio, 24h)", phone: "188", url: "https://www.cvv.org.br" },
      { label: "Defesa Civil", phone: "199" },
      { label: "CAPS — Centro de Atenção Psicossocial Salvador", url: "https://www.saude.salvador.ba.gov.br" },
      { label: "Banco de Alimentos de Salvador (FBS)", url: "https://www.fbs.org.br" },
    ],
  },
  {
    region_key: "recife_pernambuco_br",
    region_display: "Recife, Pernambuco, Brasil",
    state_code: "PE",
    country_code: "BR",
    notes: "Verified: SAMU 192, CVV 188, Defesa Civil 199. Recife / Pernambuco official sources (2026-07).",
    resources: [
      { label: "SAMU — Emergência Médica", phone: "192" },
      { label: "Bombeiros (Incêndio/Resgate)", phone: "193" },
      { label: "Polícia Militar", phone: "190" },
      { label: "CVV — Centro de Valorização da Vida", phone: "188", url: "https://www.cvv.org.br" },
      { label: "Defesa Civil Recife", phone: "199" },
      { label: "Centro POP — população em situação de rua", phone: "(81) 3184-3370" },
      { label: "CAPS Recife (saúde mental)", url: "https://www2.recife.pe.gov.br/servico/caps" },
    ],
  },
  {
    region_key: "sao_paulo_sp_br",
    region_display: "São Paulo, SP, Brasil",
    state_code: "SP",
    country_code: "BR",
    notes: "Verified: SAMU 192, CVV 188, Defesa Civil 199. São Paulo city/state official sources (2026-07).",
    resources: [
      { label: "SAMU — Emergência Médica", phone: "192" },
      { label: "Bombeiros (Incêndio/Resgate)", phone: "193" },
      { label: "Polícia Militar", phone: "190" },
      { label: "CVV — Centro de Valorização da Vida", phone: "188", url: "https://www.cvv.org.br" },
      { label: "Defesa Civil São Paulo", phone: "199" },
      { label: "CTA — Central de Triagem e Acolhimento (abrigo)", phone: "156" },
      { label: "Banco de Alimentos São Paulo", url: "https://www.bancodealimentos.org.br" },
      { label: "CAPS SP (Saúde Mental)", url: "https://www.prefeitura.sp.gov.br/cidade/secretarias/saude/atencao_basica/caps/" },
    ],
  },
  {
    region_key: "sao_luis_maranhao_br",
    region_display: "São Luís, Maranhão, Brasil",
    state_code: "MA",
    country_code: "BR",
    notes: "Verified: SAMU 192, CVV 188, Defesa Civil 199. São Luís / Maranhão official sources (2026-07).",
    resources: [
      { label: "SAMU — Emergência Médica", phone: "192" },
      { label: "Bombeiros (Incêndio/Resgate)", phone: "193" },
      { label: "Polícia Militar", phone: "190" },
      { label: "CVV — Centro de Valorização da Vida", phone: "188", url: "https://www.cvv.org.br" },
      { label: "Defesa Civil Maranhão", phone: "199" },
      { label: "CAPS São Luís (saúde mental)", url: "https://www.saoluis.ma.gov.br" },
    ],
  },
];
    ...
    try {
      const result = await db
        ...
        .values({
          ...
          country_code: region.country_code ?? "US",
