...
| Role | Email | Password | DB id | Notes |
|---|---|---|---|---|
| **Admin** | admin@niakofa.app | NiakofaAdmin2026! | 1 | `is_admin=true` set via psql |
| **Helper** | helper@niakofa.app | NiakofaHelper2026! | 2 | `helper_status='approved'` set via psql; `is_helper=true` |
| **User** | user@niakofa.app | NiakofaUser2026! | 3 | `approval_status='approved'` (auto, individual account) |
