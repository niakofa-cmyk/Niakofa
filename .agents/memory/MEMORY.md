...
- [Niakofa dispatch suggest](niakofa-dispatch-suggest.md) — POST /helpers/auto-assign/:requestId returns helper_id/helper_name (not suggested_*); advisory only, never writes DB; admin UI in SystemTab > DispatchSuggestSection.
