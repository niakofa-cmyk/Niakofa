...
4. Seed test accounts: admin@niakofa.app, helper@niakofa.app, user@niakofa.app (passwords are set by whoever seeds them — never store them in memory/docs; look up or reset via psql if forgotten).
