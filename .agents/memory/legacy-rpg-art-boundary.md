...
prosperous versus ravaged architecture or a migration landmark). Generic NPC
sprites must remain ambient conversation cues, not family identities.

**Why:** The uploaded village pack adds useful environmental storytelling, but
its art provenance is still separate from the Family Vault and cannot establish
who lived in a place.

**How to apply:** Keep the village catalog separate from the character engine,
bind art changes to deterministic demo/world state, and retain the complete
archives and entry manifests under the reference bundle.