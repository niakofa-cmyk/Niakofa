-- 0101_legacy_phase5_enhancements.sql
--
-- Phase 5 Enhancements — AI Game Director, Memory Mysteries, Living Character Evolution
--
-- Three new systems that close the remaining gaps from the Living Family Legacy
-- Experience design document:
--
-- 1. legacy_memory_mysteries — collaborative investigations for unknown faces,
--    places, and documents. The AI Game Director identifies gaps in the vault
--    (unidentified people in photos, unknown locations, missing event details)
--    and turns them into "Mystery Quests" the family solves together.
--
-- 2. legacy_ai_director_missions — daily AI-generated missions derived from
--    what's actually missing in the vault. The AI Director scans the family's
--    knowledge graph and creates targeted missions that drive preservation.
--
-- 3. legacy_character_evolution — tracks how each family member's game
--    character evolves as new stories, memories, interviews, and photos are
--    added. Each row links a character to a knowledge version, capturing
--    their stats, new dialogue lines, journal entries, and unlocked content
