...
| `/admin/civic/resources` | GET | AdminCivicRequestsTab → CivicResourcesSection (Resource Directory sub-tab) | ✅ |
| `/admin/civic/resources` | POST | AdminCivicRequestsTab → CivicResourcesSection — Add | ✅ |
| `/admin/civic/resources/:id` | PATCH | AdminCivicRequestsTab → CivicResourcesSection — Edit | ✅ |
| `/admin/civic/resources/:id` | DELETE | AdminCivicRequestsTab → CivicResourcesSection — Delete | ✅ |
