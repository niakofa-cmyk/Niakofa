...
export const sankofaCssPhase12to13 = `
        ...
        /* ── Saccade snap mode — instant jump, no ease-out (real bird behaviour) ──
           data-gaze-snap="true" is set for ~80ms after each saccade snap fires by
           useIdleState. Suppressing the transition here produces the characteristic
           snap-hold-snap pattern instead of smooth camera-like tracking.
           After 80ms the attribute reverts to "false" and transitions resume.
           Uses !important to win over the per-direction transition rules above. */
        .sankofa-bird-rig[data-gaze-snap="true"] .sankofa-bird-head {
          transition: rotate 0ms !important; }
        .sankofa-bird-rig[data-gaze-snap="true"] .sankofa-bird-neck {
          transition: rotate 0ms !important; }
        .sankofa-bird-rig[data-gaze-snap="true"] .sankofa-bird-body {
          transition: rotate 0ms !important; }
        .sankofa-bird-rig[data-gaze-snap="true"] .sankofa-bird-iris {
          transition: transform 0ms !important; }
        .sankofa-bird-rig[data-gaze-snap="true"] .sankofa-bird-eye,
        .sankofa-bird-rig[data-gaze-snap="true"] .sankofa-bird-eye-catchlight {
          transition: transform 0ms !important; }
