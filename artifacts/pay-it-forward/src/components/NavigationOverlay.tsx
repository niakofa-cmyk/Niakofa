...
interface NavigationOverlayProps {
  ...
  /**
   * Called whenever the current navigation step advances (0-based index).
   * Lets the parent derive upcomingTurnDirection for the SankofaBird's
   * anticipatory gaze — the bird glances toward the next turn before the
   * voice instruction fires.
   */
