...
export function HelperMarker({ helper }: HelperMarkerProps) {
  ...
  return (
    <div
      ...
      className="relative flex items-center justify-center w-10 h-10 cursor-pointer outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 rounded-full"
