...
function HelperMarkerImpl({ helper }: HelperMarkerProps) {
  ...
  return (
    ...
    >
      {/* Pulse ring — decorative halo, suppressed when Reduce Motion is on */}
      <div className={`absolute w-10 h-10 bg-primary/20 rounded-full border border-primary/40${suppressed ? "" : " animate-pulse"}`} />
