...
export const sankofaCssPhase14to19 = `
        ...
        /* ═══════════════════════════════════════════════════════════════════
           PHASE 19 — Compass-quadrant Posture Cues
           The SVG anatomy (wrapped in .sankofa-bird-heading-wrapper) now
           rotates a full 360 deg to face the direction of travel, so the head
           always points toward the heading for all 8 compass directions.

           Heading direction is communicated by:
             1. Full 360 deg rotation of .sankofa-bird-heading-wrapper (<g>)
             2. head/neck gaze system (--gaze-rotate-deg) in bird-local space
             3. body banking (effectiveBankDeg ±25 deg) on the rig div
             4. data-heading-quadrant: 8 subtle posture cues below (local space)

           The quadrant posture cues below are still valid: neck/tail rotations
           apply in the bird's LOCAL coordinate space (inside the heading <g>),
           so "neck cranes forward" still means toward the direction of travel
           regardless of compass heading. They are additive and gentle —
           max 1.5 px / 2 deg — accent-only and suppressed in battery-saver mode.
           ═══════════════════════════════════════════════════════════════════ */
        ...
        /* -- P19.3 East/West heading: full rotation is the primary cue -----------
           For E/W headings the .sankofa-bird-heading-wrapper 180 deg / 0 deg
           rotation puts the head pointing directly right or left. The existing
           head-lead angle (+bankDeg gaze) and P17 kinematic chain fully describe
           lateral banked flight. No additional body cues needed for E/W. */
        /* (no additional rules needed — heading rotation handles E/W) */
