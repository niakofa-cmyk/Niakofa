 ...
 * Allows admins to manually override the status when Checkr is not yet integrated,
 * or to correct edge cases.
 *
 * When Checkr IS integrated, the status auto-updates via webhook and this panel
 * serves as an audit view + override safety valve.
 */
      ...
      {counts.not_started > 0 && (
        <div className="bg-amber-500/10 border border-amber-500/30 rounded-xl px-4 py-2.5 flex items-start gap-2">
          ...
          <p className="text-xs text-amber-300 leading-relaxed">
            ...
            {" "}When Checkr is integrated, status updates automatically via webhook.
          </p>
        </div>
      )}
