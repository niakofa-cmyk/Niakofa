  ...
  return (
    ...
    >
      ...
      <style>{`
        ...
        /* ── Body + wing anticipation for upcoming turn ───────────────────────
           The head glances first (above), then the body follows with a subtle
           lean and the outside wing pre-extends — exactly how real birds bank.
           Timed at the same 2.2s period as the head so they move together.
           Body lean is intentionally subtle (±1.5°) so it reads as intelligent
           anticipation, not fighting the GPS-driven bank animation. */
        .sankofa-bird-rig[data-flying="true"][data-upcoming-turn="left"] .sankofa-bird-body {
          animation: sankofa-body-anticipate-left 2.2s ease-in-out infinite;
          transform-box: view-box;
          transform-origin: 20px 22px;
        }
        .sankofa-bird-rig[data-flying="true"][data-upcoming-turn="right"] .sankofa-bird-body {
          animation: sankofa-body-anticipate-right 2.2s ease-in-out infinite;
          transform-box: view-box;
          transform-origin: 20px 22px;
        }
        /* Outside wing pre-extends into the approaching turn direction */
        .sankofa-bird-rig[data-flying="true"][data-upcoming-turn="left"] .sankofa-bird-wing-right {
          animation: sankofa-wing-pre-extend 2.2s ease-in-out infinite;
          transform-box: view-box;
        ...
        /* Leading-edge primary feathers compress under air load before the bank */
        .sankofa-bird-rig[data-flying="true"][data-upcoming-turn="left"] .sankofa-feather-l0,
        .sankofa-bird-rig[data-flying="true"][data-upcoming-turn="left"] .sankofa-feather-l1 {
          animation: sankofa-feather-compress 2.2s ease-in-out infinite !important;
        }
        .sankofa-bird-rig[data-flying="true"][data-upcoming-turn="right"] .sankofa-feather-r0,
        .sankofa-bird-rig[data-flying="true"][data-upcoming-turn="right"] .sankofa-feather-r1 {
          animation: sankofa-feather-compress 2.2s ease-in-out infinite !important;
        }
        @keyframes sankofa-body-anticipate-left {
          0%,100% { transform: rotate(0deg) translateX(0); }
          38%     { transform: rotate(-1.5deg) translateX(-0.5px); }
          68%     { transform: rotate(-0.7deg) translateX(-0.2px); }
        }
        @keyframes sankofa-body-anticipate-right {
          0%,100% { transform: rotate(0deg) translateX(0); }
          38%     { transform: rotate(1.5deg) translateX(0.5px); }
          68%     { transform: rotate(0.7deg) translateX(0.2px); }
        }
        @keyframes sankofa-wing-pre-extend {
          /* Outside wing fans outward slightly — air displacement before the bank */
          0%,100% { transform: scaleX(1.0) translateX(0px); }
          38%     { transform: scaleX(1.09) translateX(1px); }
          68%     { transform: scaleX(1.04) translateX(0.4px); }
        }
        @keyframes sankofa-feather-compress {
          /* Primary feather tip loads against air resistance before the bank */
          0%,100% { transform: scaleX(1.0) rotate(0deg); }
          35%     { transform: scaleX(0.87) rotate(-2.5deg); }
          65%     { transform: scaleX(0.93) rotate(-1.2deg); }
        }
        ...
        /* Note: @keyframes sankofa-legs-dangle is defined later with the richer
           pendulum physics (rotate sweep + translateY). This duplicate was removed
           to avoid the browser using the simpler version via cascade order. */
