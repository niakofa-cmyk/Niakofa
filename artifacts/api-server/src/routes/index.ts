...
router.use(healthRouter); router.use(verificationRouter); router.use(usersRouter); router.use(requestsRouter); router.use(helpersRouter); router.use(navigationRouter); router.use(pushRouter); router.use(stripeRouter); router.use(leaderboardRouter); router.use(gratitudeRouter); router.use(reportsRouter); router.use(civicRouter); router.use(adminAnalyticsRouter); router.use(adminCommunitiesRouter); router.use(communitiesRouter); router.use(crisisRouter); router.use(recurringRouter); router.use(communityNeighborhoodsRouter); router.use(regionCrisisResourcesRouter); router.use(niaContextRouter); router.use(niaVoiceRouter); router.use(niaProxyRouter); router.use(poolRouter); router.use(poolStripeReconciliationRouter); router.use(adminPoolSettlementsRouter); router.use(businessesRouter); router.use(govSponsorsRouter); router.use(backgroundChecksRouter); router.use(walletRouter); router.use(googleAuthRouter); router.use("/checkin", checkinRouter); router.use(disputesRouter); router.use(impactRouter); router.use(griotRouter); router.use(audioCirclesRouter); router.use(circleLocationRouter); router.use(circleRecordingsRouter); router.use(circleHeartbeatRouter); router.use(circleMediaTokenRouter); router.use(circleLiveKitHealthRouter); router.use(webrtcIceRouter); router.use(coverageInterestRouter); router.use(familyRouter); router.use(familyConsentRouter); router.use(dnaMatchingRouter); router.use(diasporaResearchRouter); router.use(diasporaConnectionsRouter); router.use(diasporaCompletionRouter); router.use(diasporaRouter); router.use(legacyRouter); router.use(legacyCompletenessRouter); router.use(legacyChaptersRouter); router.use(legacyAchievementsRouter); router.use(legacyMapRouter); router.use(legacyChallengesRouter); router.use(legacySeasonalEventsRouter); router.use(legacyGameMasterRouter); router.use(legacyWorldEvolutionRouter); router.use(legacyAiDirectorRouter); router.use(legacyMemoryMysteriesRouter); router.use(legacyCharacterEvolutionRouter); router.use(legacyReunionRouter); router.use(legacyFamilyQuestsRouter); router.use(legacyCoopRouter); router.use(legacyInterviewQuestRouter); router.use(legacyAutoJournalRouter); router.use(legacyLaunchRouter);
