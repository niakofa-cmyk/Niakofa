...
export const requestHelpersTable = pgTable(
  "request_helpers",
  {
    ...
    // onDelete: "set null" (migration 0070) — was "cascade". This row is part of
    // the multi-helper payment-split trail (see niakofa-payment-splitting), so a
    // helper deleting their account must not erase the record that they were
    // once part of a chain and received a share of the payout.
