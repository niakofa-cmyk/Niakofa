...
## Test Accounts (emails only — never store passwords in memory/docs)
- Admin: `admin@niakofa.app` (id=1, is_admin=true)
- Helper: `helper@niakofa.app` (id=2, helper_status=approved)
- User: `user@niakofa.app` (id=3, standard user)
