  ...
  try {
    ...
    const [
      ...
      db
        .select({
          ...
          // Weekly transparency: "helpers earned this week" — the "good people paid every day" promise
    ...
    return res.json({
      ...
      pool: {
        ...
        helpers_earned_7d: pool?.helpers_earned_7d ?? 0,
        helpers_paid_7d:   pool?.helpers_paid_7d ?? 0,
        health_pct:
